...
from twilio_voice_openapi import TwilioVoiceOpenAPI, AsyncTwilioVoiceOpenAPI, APIResponseValidationError
from twilio_voice_openapi._types import Omit
from twilio_voice_openapi._utils import parse_date
from twilio_voice_openapi._models import BaseModel, FinalRequestOptions
from twilio_voice_openapi._constants import RAW_RESPONSE_HEADER
from twilio_voice_openapi._exceptions import (
    APIStatusError,
    APITimeoutError,
    TwilioVoiceOpenAPIError,
    APIResponseValidationError,
)
from twilio_voice_openapi._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: TwilioVoiceOpenAPI | AsyncTwilioVoiceOpenAPI) -> int:
...
class TestTwilioVoiceOpenAPI:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "twilio_voice_openapi/_legacy_response.py",
                        "twilio_voice_openapi/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "twilio_voice_openapi/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TwilioVoiceOpenAPIError):
            with update_env(
                **{
                    "TWILIO_VOICE_OPENAPI_USERNAME": Omit(),
                    "TWILIO_VOICE_OPENAPI_PASSWORD": Omit(),
                }
            ):
                client2 = TwilioVoiceOpenAPI(
    ...
    def test_multipart_repeating_array(self, client: TwilioVoiceOpenAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TWILIO_VOICE_OPENAPI_BASE_URL="http://localhost:5000/from/env"):
            client = TwilioVoiceOpenAPI(username=username, password=password, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: TwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: TwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: TwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = TwilioVoiceOpenAPI(
            base_url=base_url, username=username, password=password, _strict_response_validation=True
        )
    ...
    @mock.patch("twilio_voice_openapi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.delete("/v1/Archives/2019-12-27/Calls/CAE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD").mock(
            side_effect=httpx.TimeoutException("Test timeout error")
        )

        with pytest.raises(APITimeoutError):
            self.client.delete(
                "/v1/Archives/2019-12-27/Calls/CAE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD",
    ...
    def test_retries_taken(
        ...
        response = client.archives.with_raw_response.delete_call(
            sid="CAE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD", date=parse_date("2019-12-27")
        )
    ...
    def test_omit_retry_count_header(
        self, client: TwilioVoiceOpenAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncTwilioVoiceOpenAPI:
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncTwilioVoiceOpenAPI(
            base_url=base_url,
            username=username,
            password=password,
            _strict_response_validation=True,
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTwilioVoiceOpenAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TWILIO_VOICE_OPENAPI_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTwilioVoiceOpenAPI(username=username, password=password, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTwilioVoiceOpenAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTwilioVoiceOpenAPI(
            base_url=base_url, username=username, password=password, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncTwilioVoiceOpenAPI,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.archives.with_raw_response.delete_call(
            sid="CAE1CB97d8EBbDbaAae6d9B1ca0D1cFaAD", date=parse_date("2019-12-27")
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTwilioVoiceOpenAPI, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
