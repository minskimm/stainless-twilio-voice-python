...
class TargetUpdateParams(TypedDict, total=False):
    connection_policy_sid: Required[Annotated[str, PropertyInfo(alias="ConnectionPolicySid")]]
    ...
    Can be an integer from 0 to 65535, inclusive. The lowest number represents the
    most important target.
    """

    target: Annotated[str, PropertyInfo(alias="Target")]
